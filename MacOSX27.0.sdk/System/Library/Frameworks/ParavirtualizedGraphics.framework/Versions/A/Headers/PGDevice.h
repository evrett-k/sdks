...
/*!
 ...
 @deprecated The legacy memory mapping path has been removed.
 */
typedef struct PGTask_s PGTask_t API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
...
/*!
 ...
 @deprecated The legacy memory mapping path has been removed.
 */
typedef struct PGTraceRange_s PGTraceRange_t API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef PGTask_t * _Nullable (^PGCreateTask)(uint64_t vmSize, void * _Nullable * _Nonnull baseAddress) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef void (^PGDestroyTask)(PGTask_t * _Nonnull task) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef bool(^PGMapMemory)(PGTask_t * _Nonnull task, uint32_t rangeCount, uint64_t virtualOffset, bool readOnly, PGPhysicalMemoryRange_t * _Nonnull ranges) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef bool(^PGUnmapMemory)(PGTask_t * _Nonnull task, uint64_t virtualOffset, uint64_t length) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef bool(^PGReadMemory)(uint64_t physicalAddress, uint64_t length, void * _Nonnull dst) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef void(^PGTraceRangeHandler)(PGPhysicalMemoryRange_t * _Nonnull dirty) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef PGTraceRange_t* _Nullable(^PGAddTraceRange)(PGPhysicalMemoryRange_t * _Nonnull range, PGTraceRangeHandler _Nonnull handler) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
typedef void(^PGRemoveTraceRange)(PGTraceRange_t * _Nonnull range) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
...
/*!
 ...
 @deprecated The legacy memory mapping path has been removed.
 */
@property (readwrite, nonatomic, copy, nullable) PGCreateTask createTask API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
...
/*!
 ...
 @deprecated The legacy memory mapping path has been removed.
 */
@property (readwrite, nonatomic, copy, nullable) PGDestroyTask destroyTask API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
...
/*!
 ...
 @deprecated The legacy memory mapping path has been removed.
 */
@property (readwrite, nonatomic, copy, nullable) PGMapMemory mapMemory API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
...
/*!
 ...
 @deprecated The legacy memory mapping path has been removed.
 */
@property (readwrite, nonatomic, copy, nullable) PGUnmapMemory unmapMemory API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
...
/*!
 ...
 @deprecated The legacy memory mapping path has been removed.
 */
@property (readwrite, nonatomic, copy, nullable) PGReadMemory readMemory API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
@property (readwrite, nonatomic, copy, nullable) PGAddTraceRange addTraceRange API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
@property (readwrite, nonatomic, copy, nullable) PGRemoveTraceRange removeTraceRange API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios, tvos);
 ...
 */
PG_EXTERN id<PGDevice> _Nullable PGNewDeviceWithDescriptor(PGDeviceDescriptor * _Nonnull descriptor) API_OBSOLETED_WITH_REPLACEMENT("PGCreateDeviceWithDescriptor", macos(11.0, 15.2, 27.0)) API_UNAVAILABLE(ios, tvos);
...
/*!
 ...
 the device.
 @return The URL.
 @deprecated The Option ROM is no longer used.
 */
PG_EXTERN NSURL * _Nonnull PGCopyOptionROMURL(void) API_DEPRECATED("Deprecated", macos(11.0, 27.0)) API_UNAVAILABLE(ios);
