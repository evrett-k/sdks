...
/*!
 ...
 @discussion The legacy cursor glyph handler is no longer available.
 @param glyph Cursor glyph to apply.
 @param hotSpot Top,left relative location of hotSpot.
 */
typedef void (^PGDisplayCursorGlyphHandler)(NSBitmapImageRep * _Nonnull glyph, PGDisplayCoord_t hotSpot) API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios);
#endif
...
/*!
 ...
 @deprecated The legacy cursor glyph handler is no longer available.
 */
@property(readwrite, nonatomic, nullable, copy) PGDisplayCursorGlyphHandler cursorGlyphHandler API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios);
#endif
...
/*!
 ...
 @deprecated The legacy cursor glyph handler is no longer available.
 */
@property(readonly, nonatomic, nullable) PGDisplayCursorGlyphHandler cursorGlyphHandler API_OBSOLETED("No longer supported", macos(11.0, 27.0, 27.0)) API_UNAVAILABLE(ios);
#endif
