...
- (void)openPaymentSetupWithMerchantIdentifier:(NSString *)merchantIdentifier NS_SWIFT_NAME(openPaymentSetup(merchantIdentifier:)) NS_SWIFT_NAME(openPaymentSetup(merchantIdentifier:)) API_AVAILABLE(macos(26.4), ios(26.4), visionos(26.4)) API_UNAVAILABLE(watchos);
