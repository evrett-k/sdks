 ...
 *              For optimized performance, use an NSMutableData allocated by <code>[IOUSBHostObject dataWithCapacity:options]</code>.
 ...
 *              use an NSMutableData allocated by <code>[IOUSBHostObject dataWithCapacity:options]</code> with
 ...
 *              initialization requirements and usage.
 * @param       data An NSMutableData* to be used as the backing store for the I/O.  For optimized performance,
 *              use an NSMutableData allocated by <code>[IOUSBHostObject dataWithCapacity:options]</code>.
