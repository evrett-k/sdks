 ...
 */
extern const char * 
GetMacOSStatusErrorString(OSStatus err)                       API_AVAILABLE(macos(10.4), macCatalyst(11.0), ios(27.0)) API_UNAVAILABLE(tvos, watchos );
 ...
 */
extern const char * 
GetMacOSStatusCommentString(OSStatus err)                     API_AVAILABLE(macos(10.4), macCatalyst(11.0), ios(27.0) ) API_UNAVAILABLE( tvos, watchos ) ;
