...
+ (NSInteger)maximumDimensionForSpatialScaleFactor:(NSInteger)spatialScaleFactor API_AVAILABLE(macos(27.0), ios(27.0), tvos(27.0), visionos(27.0)) API_UNAVAILABLE(watchos);
...
/// Pass `1` for `spatialScaleFactor` when using the processor for temporal interpolation without spatial scaling.
/// Returns `0` if an unsupported scale factor is provided.
+ (NSInteger)maximumPixelCountForSpatialScaleFactor:(NSInteger)spatialScaleFactor API_AVAILABLE(macos(27.0), ios(27.0), tvos(27.0), visionos(27.0)) API_UNAVAILABLE(watchos);
