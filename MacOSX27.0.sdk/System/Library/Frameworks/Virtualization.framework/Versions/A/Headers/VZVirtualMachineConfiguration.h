 ...
 */
@property (readwrite, copy) NSArray<VZCustomVirtioDeviceConfiguration *> *customVirtioDevices API_AVAILABLE(macos(27.0));
...
@property (nullable, copy) NSString *label API_AVAILABLE(macos(27.0));
