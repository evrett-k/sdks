/* iig(DriverKit-509.0.1) generated from IOService.iig */
...
/* source class IOService IOService.iig:90-620 */
...
public:
    ...
    * @param    waitForFunction If <code>true</code>, <code>CallPlatformFunction</code> will not
    *           return until the function has been called.
    * @param    inParam Dictionary containing the input parameters.
    * @param    outParam Pointer to a storage that will contain the output parameters.
    * @result   An IOReturn code; <code>kIOReturnSuccess</code> if the function was successfully
    *           executed, <code>kIOReturnUnsupported</code> if a service to execute the function
    *           could not be found. Other return codes may be returned by the function.
	*/
	virtual kern_return_t
	CallPlatformFunction(OSString * functionName, bool waitForFunction,
		OSDictionary * inParam, OSDictionary ** outParam) LOCAL SERIALIZABLE;
...
/* generated class IOService IOService.iig:90-620 */
...
#define IOService_CallPlatformFunction_ID            0xbf66f4287c60ef85ULL
...
#define IOService_CallPlatformFunction_Args \
        OSString * functionName, \
        bool waitForFunction, \
        OSDictionary * inParam, \
        OSDictionary ** outParam
...
\
    kern_return_t\
    CallPlatformFunction_Impl(IOService_CallPlatformFunction_Args);\
\
    void\
...
\
    typedef kern_return_t (*CallPlatformFunction_Handler)(OSMetaClassBase * target, IOService_CallPlatformFunction_Args);\
    static kern_return_t\
    CallPlatformFunction_Invoke(const IORPC rpc,\
        OSMetaClassBase * target,\
        CallPlatformFunction_Handler func);\
\
