...
#import <Foundation/Foundation.h>
   ...
   #define SYNCSERVICES_EXPORT_CLASS __declspec(dllexport)
   ...
   #define SYNCSERVICESUI_EXPORT_CLASS __declspec(dllexport)

#elif TARGET_OS_MAC

   #define SYNCSERVICES_IMPORT SYNCSERVICES_EXTERN
   #define SYNCSERVICES_EXPORT __attribute__((visibility("default"))) SYNCSERVICES_EXTERN
   #define SYNCSERVICES_EXPORT_DEFINITION __attribute__((visibility("default")))
   #define SYNCSERVICES_EXPORT_CLASS __attribute__((visibility("default")))

   #define SYNCSERVICESUI_IMPORT SYNCSERVICES_EXTERN
   #define SYNCSERVICESUI_EXPORT __attribute__((visibility("default"))) SYNCSERVICES_EXTERN
   #define SYNCSERVICESUI_EXPORT_DEFINITION __attribute__((visibility("default")))
   #define SYNCSERVICESUI_EXPORT_CLASS __attribute__((visibility("default")))
#endif
