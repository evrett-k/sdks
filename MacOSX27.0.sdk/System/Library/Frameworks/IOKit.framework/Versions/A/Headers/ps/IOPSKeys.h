...
/*!
 *  @define     kIOPSFailureSafetyUnderVoltage
 *
 *  @abstract   Potential value for key <code>@link kIOPSBatteryFailureModesKey@/link</code>
 */
#define kIOPSFailureSafetyUnderVoltage              "Safety Under-Voltage"
/*!
 *  @define     kIOPSFailureSecondLevelProtection
 *
 *  @abstract   Potential value for key <code>@link kIOPSBatteryFailureModesKey@/link</code>
 */
#define kIOPSFailureSecondLevelProtection           "Second Level Protection Triggered"
/*!
 *  @define     kIOPSFailureAFEReadWriteFail
 *
 *  @abstract   Potential value for key <code>@link kIOPSBatteryFailureModesKey@/link</code>
 */
#define kIOPSFailureAFEReadWriteFail                "AFE Read/Write Fail"
/*!
 *  @define     kIOPSFailureAFEComparisonFail
 *
 *  @abstract   Potential value for key <code>@link kIOPSBatteryFailureModesKey@/link</code>
 */
#define kIOPSFailureAFEComparisonFail               "AFE Comparison Fail"
/*!
 *  @define     kIOPSFailureVoltageImbalanceActive
 *
 *  @abstract   Potential value for key <code>@link kIOPSBatteryFailureModesKey@/link</code>
 */
#define kIOPSFailureVoltageImbalanceActive          "Voltage Imbalance Active"
/*!
 *  @define     kIOPSFailureVoltageImbalanceRest
 *
 *  @abstract   Potential value for key <code>@link kIOPSBatteryFailureModesKey@/link</code>
 */
#define kIOPSFailureVoltageImbalanceRest            "Voltage Imbalance Rest"
