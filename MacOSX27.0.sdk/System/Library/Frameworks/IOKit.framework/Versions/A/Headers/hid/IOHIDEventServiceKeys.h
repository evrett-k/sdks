...
/*!
     @defined kIOHIDEventServicePropertiesRequiredForMatching
     @discussion Properties define array of the property keys that require to be presented in matching dictionary to match service by HIDEventSystemClient
     Providing  kIOHIDEventServicePropertiesRequiredForMatching with value "*" in  matching dictionary will  instruct system to ignore  kIOHIDEventServicePropertiesRequiredForMatching provided by service.
 */
#define kIOHIDEventServicePropertiesRequiredForMatching "HIDPropertiesRequiredForMatching"
