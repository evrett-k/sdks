...
// can be used by subclasses to define class-wide prevention rules.  Returning NO indicates that success of this recognizer cannot prevent
// success of the preventedGestureRecognizer (i.e., they will be allowed to recognize simultaneously).
// for example, an NSClickGestureRecognizer never prevents another NSClickGestureRecognizer with a higher click count
// the default implementation returns YES (by default, no two gestures can be recognized simultaneously).
