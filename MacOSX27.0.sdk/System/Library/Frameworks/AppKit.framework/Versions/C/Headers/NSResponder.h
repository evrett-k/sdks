...
/* A new set of touches has been recognized. To get the set of touches that began for this view (or descendants of this view): [event touchesMatchingPhase:NSTouchPhaseBegan inView:self];
    Note: this is not always the point of contact with the touch device. A touch that transitions from resting to active may be part of a Began set.
    Note: These 'touches' responder methods are used for indirect touches and touchbar devices only.  They are not used for Sidecar devices.
*/
