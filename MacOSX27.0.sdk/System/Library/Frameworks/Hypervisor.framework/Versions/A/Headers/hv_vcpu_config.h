...
OS_ENUM(hv_feature_reg, uint32_t,
    ...
    HV_FEATURE_REG_ID_AA64ISAR2_EL1 API_AVAILABLE(macos(27.0)),
    HV_FEATURE_REG_ID_AA64PFR2_EL1 API_AVAILABLE(macos(27.0)),
    HV_FEATURE_REG_ID_AA64MMFR3_EL1 API_AVAILABLE(macos(27.0)),
    HV_FEATURE_REG_ID_AA64MMFR4_EL1 API_AVAILABLE(macos(27.0)),
);
