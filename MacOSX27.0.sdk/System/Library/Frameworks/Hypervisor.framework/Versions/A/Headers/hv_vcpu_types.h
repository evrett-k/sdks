...
OS_ENUM(hv_sys_reg, uint16_t,
    ...
    HV_SYS_REG_ID_AA64PFR2_EL1 API_AVAILABLE(macos(27.0)) = 0xc022,
    ...
    HV_SYS_REG_ID_AA64ISAR2_EL1 API_AVAILABLE(macos(27.0)) = 0xc032,
    HV_SYS_REG_ID_AA64MMFR0_EL1 = 0xc038,
    HV_SYS_REG_ID_AA64MMFR1_EL1 = 0xc039,
    HV_SYS_REG_ID_AA64MMFR2_EL1 = 0xc03a,
    HV_SYS_REG_ID_AA64MMFR3_EL1 API_AVAILABLE(macos(27.0)) = 0xc03b,
    HV_SYS_REG_ID_AA64MMFR4_EL1 API_AVAILABLE(macos(27.0)) = 0xc03c,
...
/*!
 ...
 @discussion Passed to hv_vcpu_get_pending_interrupt and hv_vcpu_set_pending_interrupt to get
...
OS_ENUM(hv_tlbi_op, uint16_t,
    HV_TLBI_OP_RVAE1IS = 0x11,
    HV_TLBI_OP_RVAAE1IS = 0x13,
    HV_TLBI_OP_RVALE1IS = 0x15,
    HV_TLBI_OP_RVAALE1IS = 0x17,
    HV_TLBI_OP_VMALLE1IS = 0x18,
    HV_TLBI_OP_VAE1IS = 0x19,
    HV_TLBI_OP_ASIDE1IS = 0x1a,
    HV_TLBI_OP_VAAE1IS = 0x1b,
    HV_TLBI_OP_VALE1IS = 0x1d,
    HV_TLBI_OP_VAALE1IS = 0x1f,
);
