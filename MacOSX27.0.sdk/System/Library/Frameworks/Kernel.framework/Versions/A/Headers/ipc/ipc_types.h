...
#include <kern/lock_annotations.h>
...
/* IPC-specific semantic wrappers for the lockcheck annotations */
#define XNU_IPC_LOCKCHECK_ACQUIRES_LOCK_EX      XNU_LOCKCHECK_ACQUIRES_LOCK_EX
#define XNU_IPC_LOCKCHECK_RELEASES_LOCK_EX      XNU_LOCKCHECK_RELEASES_LOCK_EX
#define XNU_IPC_LOCKCHECK_REQUIRES_LOCKED_EX    XNU_LOCKCHECK_REQUIRES_LOCK_EX
#define XNU_IPC_LOCKCHECK_REQUIRES_UNLOCKED     XNU_LOCKCHECK_REQUIRES_UNLOCKED
