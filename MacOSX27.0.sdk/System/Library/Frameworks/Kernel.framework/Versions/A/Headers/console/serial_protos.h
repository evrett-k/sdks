...
/* Prevent kext printf/vprintf writing to serial */
#define SERIALMODE_NO_KEXT_PRINTF  0x100
...
/* Shortcut for serialmode & SERIALMODE_NO_KEXT_PRINTF. */
extern bool disable_kext_printf_serial_output;
