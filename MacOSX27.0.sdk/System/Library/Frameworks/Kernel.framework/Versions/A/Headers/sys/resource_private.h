...
#define IOPOL_TYPE_VFS_LOOKUP_RESOLVE_FLAGS 15
...
#define IOPOL_CMD_ENABLE        0x00000003      /* Enable multi-bit I/O policy */
#define IOPOL_CMD_DISABLE       0x00000004      /* Disable multi-bit I/O policy */
...
int     enableiopolicy_np(int, int, int);
int     disableiopolicy_np(int, int, int);
