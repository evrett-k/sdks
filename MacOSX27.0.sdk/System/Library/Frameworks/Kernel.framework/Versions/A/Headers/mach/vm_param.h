...
/* Consumed by the machine-dependent headers */
#define TiB(x)                  ((0ULL + (x)) << 40)
#define GiB(x)                  ((0ULL + (x)) << 30)
#define MiB(x)                  ((0ULL + (x)) << 20)
#define KiB(x)                  ((0ULL + (x)) << 10)
 ...
 */
#define ANON_CHUNK_SIZE (128ULL << 20) /* 128 MiB */
 ...
 */
#define MALLOC_MEDIUM_CHUNK_SIZE (8ULL << 20) /* 8 MiB */
