 ...
 *   @constant   kIOPCIAccessWriteCombining      Hint to host software that this PCIe write should be issued in a Write-Combining (WC) manner,
...
typedef enum tIOPCIAccessOptions
{
    ...
    kIOPCIAccessWriteCombining      = (1 << 1),
} tIOPCIAccessOptions;
