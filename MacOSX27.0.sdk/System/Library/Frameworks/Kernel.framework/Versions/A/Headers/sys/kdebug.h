...
#define DBG_MACH_VM_PAGEOUT     0xB4 // Mach VM Page Replacement
...
#define MACH_SCHED_THREAD_HANDOFF        0x6a /* attempt direct context switch to identified thread */
...
#define MACH_SCHED_EDGE_SHARED_RSRC_MIGRATE     0xe /* __unused */
...
#define DBG_VM_PAGE_ACTIVATE_SPECULATIVE    0x138
...
#define DBG_VM_REFILL_MTE_2                 0x151
#define DBG_VM_KERNEL_TAGGED_INLINE         0x152
#define DBG_VM_PAGE_MTE_KERNEL_WAIT_BLOCK   0x153
...
#define DBG_VM_OBJECT_READ_AROUND           0x167
#define DBG_VM_FAULT_PAGEIN                 0x168

#define DBG_VM_PAGE_LOCAL_TO_GLOBAL_ACTIVE      0x169

#define DBG_VM_REFILL_MTE_NO_PROGRESS       0x170
...
#define DBG_CPGR_GET                     0x10
#define DBG_CPGR_PUT                     0x11
#define DBG_CPGR_CLR                     0x12
#define DBG_CPGR_REAP                    0x13

/* Codes for VM Page Replacement (DBG_MACH_VM_PAGEOUT) */
#define DBG_PGOUT_FREE_SPECULATIVE       0x01
#define DBG_PGOUT_FREE_CLEANED           0x02
#define DBG_PGOUT_FREE_ANON              0x03
#define DBG_PGOUT_FREE_EXTERNAL          0x04
...
#define MACH_EXCLAVES_SCHEDULER_REQ_RESUME_WITH_HOSTID_WITH_AST 0x13  
#define MACH_EXCLAVES_SCHEDULER_REQ_RESUME_WITH_FLAGS 0x14  
...
#define DBG_MEMINFO_PGCNT11                 0x0B
#define DBG_MEMINFO_PGCNT12                 0x0C
#define DBG_MEMINFO_PGCNT13                 0x0D
...
#define DBG_MEMINFO_PGOUT9                  0x19
#define DBG_MEMINFO_PGOUT10                 0x1A
#define DBG_MEMINFO_PGOUT11                 0x1B
#define DBG_MEMINFO_PGOUT12                 0x1C
...
#define DBG_MEMINFO_CSWAP6                  0x46
#define DBG_MEMINFO_CSWAP7                  0x47
#define DBG_MEMINFO_CSWAP8                  0x48
#define DBG_MEMINFO_CSWAP9                  0x49
#define DBG_MEMINFO_CSWAP10                 0x4A
#define DBG_MEMINFO_CSWAP11                 0x4B
#define DBG_MEMINFO_CSWAP12                 0x4C
#define DBG_MEMINFO_CSWAP13                 0x4D

#define DBG_MEMINFO_COMPACTOR1              DBG_MEMINFO_CSWAP6
#define DBG_MEMINFO_COMPACTOR2              DBG_MEMINFO_CSWAP7
#define DBG_MEMINFO_COMPACTOR3              DBG_MEMINFO_CSWAP8

/* MTE refill thread/subsystem statistics */
#define DBG_MEMINFO_MTE1                    0x60
#define DBG_MEMINFO_MTE2                    0x61
#define DBG_MEMINFO_MTE3                    0x62
#define DBG_MEMINFO_MTE4                    0x63

/* Page demand statistics, cont. */
#define DBG_MEMINFO_DEMAND3                 0x70
#define DBG_MEMINFO_DEMAND4                 0x71
#define DBG_MEMINFO_DEMAND5                 0x72
#define DBG_MEMINFO_DEMAND6                 0x73

/* Wired memory breakdown */
#define DBG_MEMINFO_WIRED1                  0x80
...
/* Codes for DBG_FSYSTEM subcode class DBG_FSRW	*/
#define FSRW_CL_BP                   19    /* 0x301004c */
#define FSRW_CL_IODONE               20    /* 0x3010050 */
#define FSRW_CL_UBC_DUMP             21    /* 0x3010054 */
#define FSRW_CL_IO                   22    /* 0x3010058 */
#define FSRW_CL_ZERO                 23    /* 0x301005c */
#define FSRW_CL_CMAP                 24    /* 0x3010060 */
#define FSRW_CL_IODONE_FINISH        25    /* 0x3010064 */
#define FSRW_CL_IOREAD               26    /* 0x3010068 */
#define FSRW_CL_IOWRITE              27    /* 0x301006c */
#define FSRW_CL_IOABORT              28    /* 0x3010070 */
#define FSRW_CL_ZERO_COMMIT          29    /* 0x3010074 */
#define FSRW_CL_WRDEL_COMMIT         30    /* 0x3010078 */
#define FSRW_CL_READ_ABORT           31    /* 0x301007c */
#define FSRW_CL_READ_COPY            32    /* 0x3010080 */
#define FSRW_CL_READ_LIST_REQ        33    /* 0x3010084 */
#define FSRW_CL_PHYS_UIOMOVE         34    /* 0x3010088 */
#define FSRW_CL_READ_COMMIT          35    /* 0x301008c */
#define FSRW_CL_WRITE_COPY           40    /* 0x30100a0 */
#define FSRW_CL_WRITE_LIST_REQ       41    /* 0x30100a4 */
#define FSRW_CL_WRITE_UIOMOVE        42    /* 0x30100a8 */
#define FSRW_CL_WRITE_ZEROS          43    /* 0x30100ac */
#define FSRW_CL_WRITE_DELAYED        44    /* 0x30100b0 */
#define FSRW_CL_WRITE_ABORT          45    /* 0x30100b4 */
#define FSRW_CL_ZERO_INFO            46    /* 0x30100b8 */
#define FSRW_CL_RD_AHEAD             48    /* 0x30100c0 */
#define FSRW_CL_RD_PREFETCH          49    /* 0x30100c4 */
#define FSRW_CL_RD_PREFABORT         50    /* 0x30100c8 */
#define FSRW_CL_WRITEPUSH            51    /* 0x30100cc */
#define FSRW_CL_PAGEOUT              52    /* 0x30100d0 */
#define FSRW_CL_PUSH                 53    /* 0x30100d4 */
#define FSRW_CL_PUSH_SPARSE_WAIT     54    /* 0x30100d8 */
#define FSRW_CL_PUSH_SPARSE_SYNC     55    /* 0x30100dc */
#define FSRW_CL_PAGEIN               56    /* 0x30100e0 */
#define FSRW_CL_TRY_PUSH             57    /* 0x30100e4 */
#define FSRW_CL_ADVISORY_RD          60    /* 0x30100f0 */
#define FSRW_CL_ADV_FAULT_LIST       61    /* 0x30100f4 */
#define FSRW_CL_ADV_ABORT1           62    /* 0x30100f8 */
#define FSRW_CL_ADV_ABORT2           63    /* 0x30100fc */
#define FSRW_CL_READ_DIRECT          70    /* 0x3010118 */
#define FSRW_CL_NCPR_UIOMV           71    /* 0x301011c */
#define FSRW_CL_NCPR_GETUPL          72    /* 0x3010120 */
#define FSRW_CL_NCPR_CLIO            73    /* 0x3010124 */
#define FSRW_CL_WRITE_DIRECT         75    /* 0x301012c */
#define FSRW_CL_NCPW_GETUPL          76    /* 0x3010130 */
#define FSRW_CL_NCPW_CLIO            77    /* 0x3010134 */
#define FSRW_CL_SPARSE_COLLECT       78    /* 0x3010138 */
#define FSRW_CL_SPARSE_PUSH          79    /* 0x301013c */
#define FSRW_CL_SPARSE_ADD           80    /* 0x3010140 */
#define FSRW_CL_RELEASE              81    /* 0x3010144 */
#define FSRW_CL_DRT_EMPTYFREE        82    /* 0x3010148 */
#define FSRW_CL_DRT_RETCLUSTER       83    /* 0x301014c */
#define FSRW_CL_DRT_ALLOCTABLE       84    /* 0x3010150 */
#define FSRW_CL_DRT_INSERT           85    /* 0x3010154 */
#define FSRW_CL_DRT_MARK             86    /* 0x3010158 */
#define FSRW_CL_DRT_6                87    /* 0x301015c */
#define FSRW_CL_DRT_FREETABLE        88    /* 0x3010160 */
#define FSRW_CL_READ_CONTIG_GETUPL   92    /* 0x3010170 */
#define FSRW_CL_WRITE_CONTIG_GETUPL  93    /* 0x3010174 */
#define FSRW_CL_IO_TYPE              94    /* 0x3010178 */
#define FSRW_CL_WAIT_IO              95    /* 0x301017c */
#define FSRW_CL_VNODE_WAITFORWRITES  160   /* 0x3010280 */

/* Codes for DBG_FSYSTEM subcode class DBG_DKRW (BIO/Buffer events) */
#define FSRW_BIO_WRITE_LIST_REQ      384   /* 0x3010600 */
#define FSRW_BIO_GETBLK_LIST_REQ     385   /* 0x3010604 */
#define FSRW_BIO_GETBLK              386   /* 0x3010608 */
#define FSRW_BIO_BIODONE             387   /* 0x301060c */
#define FSRW_BIO_BRELSE              388   /* 0x3010610 */
#define FSRW_BIO_RECOVERED_BUF       389   /* 0x3010614 */
#define FSRW_BIO_DUMPED_BUF          390   /* 0x3010618 */
#define FSRW_BIO_WRITE_DELAYED       391   /* 0x301061c */
#define FSRW_BIO_ACQUIRE_ERROR       392   /* 0x3010620 */
#define FSRW_BIO_WRITE_ASYNC         393   /* 0x3010624 */
#define FSRW_BIO_WRITE_SYNC          394   /* 0x3010628 */
#define FSRW_BIO_FLUSHDIRTY          395   /* 0x301062c */
#define FSRW_BIO_GETBLK_MSLEEP       396   /* 0x3010630 */
#define FSRW_BIO_CREATE_SHADOW       397   /* 0x3010634 */
#define FSRW_BIO_MAKE_PRIVATE        398   /* 0x3010638 */
#define FSRW_BIO_BUF_INVALIDATEBLKS  399   /* 0x301063c */
#define FSRW_BIO_BRELSE_SHADOW       400   /* 0x3010640 */
...
#define IMP_TASK_POLICY_BG_VM_QUEUE         0x25
...
#define FSRW_CODE(code) FSDBG_CODE(DBG_FSRW, code)
...
#define VM_PGOUT_EVENTID(code) KDBG_EVENTID(DBG_MACH, DBG_MACH_VM_PAGEOUT, code)
