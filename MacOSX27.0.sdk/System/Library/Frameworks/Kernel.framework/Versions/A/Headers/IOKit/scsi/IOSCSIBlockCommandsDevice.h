...
#include <IOKit/IOServicePM+IOSAM.h>
#endif /* IOSAM_UNIT_TEST */
...
private:
	...
	static void				AsyncUnmapComplete ( SCSITaskIdentifier	completedTask );

    static void             AbortPMTransition ( thread_call_param_t whichDevice );

    void                    WaitGatedForNextIssueUnmap ( void * clientData, bool done );
	...
	IOReturn				IssueReadInternal (
								IOMemoryDescriptor *	buffer,
								UInt64					startBlock,
								UInt64					blockCount,
								UInt64					mediumBlockSize,
								IOStorageAttributes *	attributes,
								UInt32					timeout,
								void *					clientData );

	IOReturn				IssueWriteInternal (
								IOMemoryDescriptor *	buffer,
								UInt64					startBlock,
								UInt64					blockCount,
								UInt64					mediumBlockSize,
