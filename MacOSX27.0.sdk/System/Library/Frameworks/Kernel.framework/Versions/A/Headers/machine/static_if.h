...
/*!
 * @function static_if_dt_property_uint32()
 *
 * @brief
 * Parses a 32-bit DeviceTree entry within a STATIC_IF_INIT() function.
 *
 * @discussion
 * STATIC_IF_INIT() functions should avoid other DeviceTree library calls.
 * static_if_dt_property_uint32() uses a subset of the DeviceTree library
 * that is safe to call during early boot.
 */
extern uint32_t static_if_dt_property_uint32(
	const char             *pathName,
