...
/*
 * Additional fixed counters that are micro-architecture-specific.
 */
#define KPC_CLASS_FIXED_UARCH   (4)
...
#define KPC_CLASS_FIXED_UARCH_MASK   (1u << KPC_CLASS_FIXED_UARCH)
