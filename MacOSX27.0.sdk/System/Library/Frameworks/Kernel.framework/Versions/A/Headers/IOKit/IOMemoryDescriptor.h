...
#endif /* !__LP64__ */
{
	...
	kIODirectionPrepareToPhys32   = 0x00000000,             /* no-op on AS */
...
#define IODIRECTIONPREPARENONCOHERENTDEFINED    1
	...
	kIODirectionPrepareShareSK     = 0x00000040,
...
#define IODIRECTIONCOMPLETEANDDEACTIVATEDEFINED 1
	kIODirectionCompleteAndDeactivate = 0x00000100
};
...
/*! @function hasDoubleBuffer
 *   @result True if the IOMD has been prepared with the kIODirectionBufferCopy option and
 *		and a buffer was created. */
	bool hasDoubleBuffer(void);
