...
class __kpi_deprecated("Use PCIDriverKit") IOPCIDevice : public IOService
{
    ...
    friend class ApplePLCELinkScripts;
...
private:
	...
	IOReturn waitForPauseReady(void *unused);
protected:
...
private:
	...
	IOReturn __CopyDeviceMemory(uint64_t memoryIndex, IOMemoryDescriptor **returnMemory, IOService *forClient, bool isWC);
	IOReturn lookupCapability(uint32_t id, uint32_t *data, uint16_t *offset);
};
__exported_pop
