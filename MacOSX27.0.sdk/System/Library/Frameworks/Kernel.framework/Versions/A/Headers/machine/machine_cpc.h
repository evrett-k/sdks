...
///
/// - Returns: An array of counters indexed by slot of length CPC_CPMU_COUNTER_COUNT.
cpc_counter_t cpc_cpmu_counters(void);

/// Get the list of CPMU deadlines for counters.
///
/// - Returns: An array of deadlines indexed by slot of length CPC_CPMU_COUNTER_COUNT.
