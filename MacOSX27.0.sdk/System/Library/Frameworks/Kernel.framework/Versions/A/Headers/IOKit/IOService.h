...
typedef IOReturn (*IOUserPlatformFunctionHandler)(IOService * target, const OSSymbol * functionName, bool waitForFunction,
    OSDictionary * inParams, OSDictionary ** outParams);
...
private:
	...
	IOReturn recordWait(IOService * resolver, AbsoluteTime startTime, AbsoluteTime endTime, bool blocking);
