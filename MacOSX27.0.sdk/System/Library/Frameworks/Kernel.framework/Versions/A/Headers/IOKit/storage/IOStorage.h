...
/*!
 * @defined kIOStorageFeatureQueuedFlush
 * @abstract
 * Describes the support of flushing outstanding writes' data to persistent medium.
 * @discussion
 * This property describes the ability of the storage stack to flush data
 * corresponding to the outstanding writes when flush/synchronize cache command
 * is received. It is one of the feature entries listed under the top-
 * level kIOStorageFeaturesKey property table.  It has an OSBoolean value.
 */

#define kIOStorageFeatureQueuedFlush "QueuedFlush"
...
#if defined(KERNEL) || defined(IOSF_UNIT_TEST)
#ifdef __cplusplus
