/* iig(DriverKit-509.0.1) generated from AFKUserDataPipe.iig */

/* AFKUserDataPipe.iig:1-36 */
/*
...
/* source class AFKUserDataPipe AFKUserDataPipe.iig:37-65 */
...
/* generated class AFKUserDataPipe AFKUserDataPipe.iig:37-65 */
...
\
    ...
    enqueueReport(\
        uint8_t packetType,\
        PayloadBuffer reportBuffer,\
        AFKEPReportOptions options) APPLE_KEXT_OVERRIDE;\
\
    virtual void\
    enqueueCommand(\
        uint8_t packetType,\
        ...
        ResponseHandler responseHandler,\
        IOService * forClient,\
        AFKEPCommandResponseOptions options) APPLE_KEXT_OVERRIDE;\
\
    virtual IOReturn\
    enqueueResponse(\
        CommandID id,\
...
public:
    ...
    virtual bool
    open(AFKEndpointInterface * service,
        CommandBlock commandHandler,
        ReportBlock reportHandler) = 0;
    ...
    bool
    open_Call(AFKEndpointInterface * service,
        CommandBlock commandHandler,
        ReportBlock reportHandler)  { return open(service, commandHandler, reportHandler); };\
    ...
    enqueueCommand_Call(uint8_t packetType,
        ...
        ResponseHandler responseHandler,
        IOService * forClient,
        AFKEPCommandResponseOptions options)  { return enqueueCommand(packetType, commandBuffer, responseHandler, forClient, options); };\
