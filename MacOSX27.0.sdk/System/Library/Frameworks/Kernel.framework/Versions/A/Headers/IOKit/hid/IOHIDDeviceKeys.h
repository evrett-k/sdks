...
/*!
 * @defined    kIOHIDDeviceHIDRMHashKey
 * @abstract
 * A SHA256 (32 byte) hash calculated based on a specific set of properties of all IOHIDDevices with a shared parent
 * Currently used in HIDRM in order to differentiate device's cached approvals
 * Set of properties currently included in the hash: kIOHIDVendorIDKey, kIOHIDProductIDKey, kIOHIDSerialNumberKey, and kIOHIDReportDescriptorKey
 */
#define kIOHIDDeviceHIDRMHashKey "HIDRMHash"
