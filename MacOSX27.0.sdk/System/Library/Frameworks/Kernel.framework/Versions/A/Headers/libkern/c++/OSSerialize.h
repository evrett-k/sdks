...
enum {
	kIOSerializeEditorOnDictionaries   = 0x1,
	kIOSerializeEditorOnArrays         = 0x2,
	kIOSerializeEditorOnSets           = 0x4,
	kIOSerializeEditorOnAllCollections = (kIOSerializeEditorOnDictionaries | kIOSerializeEditorOnArrays | kIOSerializeEditorOnSets)
};
 ...
 */
	...
	static OSPtr<OSSerialize> binaryWithCapacity(unsigned int inCapacity, unsigned int options, Editor editor = NULL, void * reference = NULL);
