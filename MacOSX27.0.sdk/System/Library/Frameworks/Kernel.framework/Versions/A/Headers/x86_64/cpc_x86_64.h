...
#define CPC_CPMU_COUNTER_COUNT (8)
...
struct cpc_cpu {
	...
	struct cpc_counter ccp_cpmu_counters[CPC_CPMU_COUNTER_COUNT];
	struct cpc_deadlines ccp_cpmu_deadlines[CPC_CPMU_COUNTER_COUNT];
};
