/* iig(DriverKit-509.0.1) generated from IOPCIDevice.iig */
...
#define IOPCIDevice__CopyWCDeviceMemoryWithIndex_ID            0xa188c0a57a59c55bULL
...
#define IOPCIDevice__CopyWCDeviceMemoryWithIndex_Args \
...
\
    typedef kern_return_t (*_CopyWCDeviceMemoryWithIndex_Handler)(OSMetaClassBase * target, IOPCIDevice__CopyWCDeviceMemoryWithIndex_Args);\
    static kern_return_t\
    _CopyWCDeviceMemoryWithIndex_Invoke(const IORPC rpc,\
        OSMetaClassBase * target,\
        _CopyWCDeviceMemoryWithIndex_Handler func);\
\
...
\
    kern_return_t\
    _CopyWCDeviceMemoryWithIndex_Impl(IOPCIDevice__CopyWCDeviceMemoryWithIndex_Args);\
\
    kern_return_t\
