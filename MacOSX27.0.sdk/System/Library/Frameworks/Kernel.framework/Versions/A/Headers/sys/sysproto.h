...
struct pipe2_args {
	char fildes_l_[PADL_(user_addr_t)]; user_addr_t fildes; char fildes_r_[PADR_(user_addr_t)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct dup3_args {
	char from_l_[PADL_(u_int)]; u_int from; char from_r_[PADR_(u_int)];
...
struct fchflagsat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(user_addr_t)]; user_addr_t path; char path_r_[PADR_(user_addr_t)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
};
struct getumask_args {
	int32_t dummy;
};
...
struct guarded_ftruncate_np_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
...
int pipe2(struct proc *, struct pipe2_args *, int *);
int sys_dup3(struct proc *, struct dup3_args *, int *);
...
int fchflagsat(struct proc *, struct fchflagsat_args *, int *);
int getumask(struct proc *, struct getumask_args *, int *);
...
int aio_readv(struct proc *, struct aio_readv_args *, int *);
int aio_writev(struct proc *, struct aio_writev_args *, int *);
#if NFSSERVER	/* XXX */
int fhopen(struct proc *, struct fhopen_args *, int *);
#else
#endif
int fsctlat(struct proc *, struct fsctlat_args *, int *);
...
int guarded_ftruncate_np(struct proc *, struct guarded_ftruncate_np_args *, int *);
