...
public:
		...
		: _csc(csc), _endArg1(0), _endArg2(0), _endArg3(0), _endArg4(0)
	{
		...
		if ((_filtered = filtered)) {
			...
			KDBG(((uint32_t)csc) | DBG_FUNC_START, arg1, arg2, arg3, arg4);
		}
	}
	...
	~IOTimeStampIntervalConstantFiltered()
	{
		if (_filtered) {
			...
			KDBG(((uint32_t)_csc) | DBG_FUNC_END, _endArg1, _endArg2, _endArg3, _endArg4);
		}
	}
private:
...
#define IOMDESC_UAT_MAP 8    /* 0x05060020 */
#define IOMDESC_UAT_UNMAP 9  /* 0x05060024 */

#define IOMDESC_VM_OBJ_ADD 10      /* 0x05060028 */
#define IOMDESC_VM_OBJ_REMOVE 11   /* 0x0506002C */
