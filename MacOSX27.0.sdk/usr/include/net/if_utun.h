/*
 * Copyright (c) 2008-2021, 2025 Apple Inc. All rights reserved.
 *
...
#define UTUN_OPT_RX_FLOW_STEERING_AUTO                  31      /* set/get (type int) */
#define UTUN_OPT_LOW_POWER_WAKE                         32      /* set/get (type int) */
